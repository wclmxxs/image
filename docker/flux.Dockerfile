...
RUN pip install --no-cache-dir transformers==5.5.0 accelerate==1.13.0 sentencepiece==0.2.1 pillow==12.3.0 einops==0.8.2 \
...
RUN python3 -c "from diffusers import Flux2Pipeline"
