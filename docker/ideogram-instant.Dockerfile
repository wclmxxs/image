...
RUN python3 -c "from diffusers import Ideogram4Pipeline, Ideogram4Transformer2DModel; from ideogram4 import MAGIC_PROMPTS; from image_lab.ideogram_fast import FastIdeogram"
